...
describe('Hardware activity aggregation unit suite', () => {
  test('aggregates activity logs by hour, day, and week correctly', () => {
    const mockItems: ActivityItem[] = [
      { entry_id: '1', timestamp: '2026-08-01T10:15:00.000Z', scanner_id: 'sc-1', locker_id: 'lk-1', result: 'success' },
      { entry_id: '2', timestamp: '2026-08-01T10:45:00.000Z', scanner_id: 'sc-1', locker_id: 'lk-1', result: 'success' },
      { entry_id: '3', timestamp: '2026-08-01T14:20:00.000Z', scanner_id: 'sc-2', locker_id: 'lk-2', result: 'denied' },
      { entry_id: '4', timestamp: '2026-07-30T09:00:00.000Z', scanner_id: 'sc-1', locker_id: 'lk-1', result: 'success' },
    ];
